...
import 'package:pizzaui/components/add_to_cart_button.dart';
import 'package:pizzaui/models/addon.dart';
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  boxShadow: [
                    BoxShadow(
                        blurRadius: 20,
                        color: const Color(0xFFBC9FA6).withOpacity(0.4),
                        spreadRadius: 12,
                        offset: const Offset(2, 2))
                  ],
                  borderRadius: const BorderRadius.all(Radius.circular(100)),
                  color: Color.fromARGB(255, 100, 173, 17),
                ),
              ),
            ),
            Row(
